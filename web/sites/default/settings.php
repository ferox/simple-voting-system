 ...
 * @endcode
 */
$settings['hash_salt'] = 'bCaJZkptqW2C7V6QOUnqF2YIypPzbSKREdvRTYqPJMZGvW-ZZ2kzky6WXnqAi8Wb5a-FVvPzZw';
...
/**
 * Checks the lando environment variables for development.
 */
$is_lando_env = getenv('LANDO') ?? FALSE;
 ...
 */
#
if ($is_lando_env && file_exists($app_root . '/' . $site_path . '/lando.settings.php')) {
